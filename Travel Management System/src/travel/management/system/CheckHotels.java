...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public void run() {
        try {
            ...
            l2.setVisible(true);
            caption.setText("Elysium Alibaug");
            star.setText("5 Star");
            l2.add(caption);
            Thread.sleep(2800);
            l2.setVisible(false);
            l3.setVisible(true);
            caption.setText("Upper Deck Resort");
            star.setText("5 Star");
            l3.add(caption);
            l3.setVisible(true);
            Thread.sleep(2800);
            l3.setVisible(false);
            l4.setVisible(true);
            caption.setText("Rambagh Palace - Jaipur");
            star.setText("5 Star");
            l4.add(caption);
            Thread.sleep(2800);
            l4.setVisible(false);
            l5.setVisible(true);
            caption.setText("Taj Palace, New Delhi");
            star.setText("5 Star");
            l5.add(caption);
            Thread.sleep(2800);
            l5.setVisible(false);
            l6.setVisible(true);
            caption.setText("Hotel Sarang Palace");
            star.setText("4 Star");
            l6.add(caption);
            Thread.sleep(2800);
            l6.setVisible(false);
            l7.setVisible(true);
            caption.setText("Hotel Malligi Hampi");
            star.setText("5 Star");
            l7.add(caption);
            Thread.sleep(2800);
            l7.setVisible(false);
            l8.setVisible(true);
            caption.setText("Woods Villa ");
            star.setText("3 Star");
            l8.add(caption);
            Thread.sleep(2800);
            l8.setVisible(false);
            l9.setVisible(true);
            caption.setText("Hotel Mountain View - Lakeside Pokhara");
            star.setText("4 Star");
            l9.add(caption);
            Thread.sleep(2800);
            l9.setVisible(false);
            l10.setVisible(true);
            caption.setText("Lotus Bay View Hotel");
            star.setText("4 Star");
            l10.add(caption);
            Thread.sleep(2800);
            l10.setVisible(false);
            l11.setVisible(true);
            caption.setText("Hotel Noorjahan Grand");
            star.setText("5 Star");
            l11.add(caption);
            Thread.sleep(2800);
    ...
    public CheckHotels() {
        ...
        caption = new JLabel();
        star = new JLabel();
        star.setBounds(45, 545, 1000, 70);
        star.setForeground(Color.white);
        star.setFont(new Font("Tahoma", Font.PLAIN, 30));
        caption.setBounds(40, 440, 1000, 70);
