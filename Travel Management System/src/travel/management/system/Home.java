...
public class Home extends JFrame{
	...
	NewLabel.setBounds(0, 0, 1950, 1000);
        ...
        JLabel l1 = new JLabel("TRAVELING TALE");
    ...
    JFrame f1= new JFrame();
        ...
        f1.add(menuBar, BorderLayout.WEST);
        f1.setSize(100, 300);
        //f1.setLocationRelativeTo(null);  // Center on screen
        f1.setVisible(true);
        setJMenuBar(menuBar);

        JMenu m1 = new JMenu("CUSTOMER");
        m1.setForeground(Color.BLACK);
        m1.setFont(new Font("Times Roman", Font.BOLD, 15));
        ...
        m2.setFont(new Font("Times Roman", Font.BOLD, 15));
        menuBar.add(m2);
        ...
        m3.setFont(new Font("Times Roman", Font.BOLD, 15));
        menuBar.add(m3);
        ...
        m4.setFont(new Font("Times Roman", Font.BOLD, 15));
        menuBar.add(m4);
        ...
        m5.setFont(new Font("Times Roman", Font.BOLD, 15));
        menuBar.add(m5);
        ...
        m7.setFont(new Font("Times Roman", Font.BOLD, 15));
        menuBar.add(m7);
